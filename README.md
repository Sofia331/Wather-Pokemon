...
- Para isso deve ser utilizada a API chamada **"By city name"**.
  - Ex.: https://api.openweathermap.org/data/2.5/weather?q=NOME_DA_CIDADE&appid=API_KEY
...
- Todo o código deve ser adicionado no em seu [Github](https://github.com/) ou [Gitlab](https://gitlab.com/) pessoal, além da documentação no formato markdown facilmente aceito por essas plataformas. **(requisito obrigatório)**
...
> Recomendamos o uso de uma ferramenta chamada [Postman](https://www.postman.com/downloads/) ou [Insomnia](https://insomnia.rest/download/) para realizar o testes com as API(s) (/);
